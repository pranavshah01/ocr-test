...
class OCRConfig:
    ...
    text_mode: str = "replace"  # Only "append" or "replace" allowed
    ...
    def _validate_paths(self):
        ...
        for directory in [self.processed_dir, self.reports_dir, self.logs_dir, self.ocr_dir]:
    ...
    def from_cli_args() -> "OCRConfig":
        ...
        parser.add_argument("--ocr-dir", type=str, default="./ocr", help="Directory for OCR results")
        ...
        parser.add_argument("--text-mode", type=str, choices=["replace", "append"], default="replace", help="Text processing mode: replace original text or append to it")

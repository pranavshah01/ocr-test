...
class GraphicsReasoning:
    ...
    new_size_fit_percent: str = ""
    reduction_percent: str = ""
    new_size_change: str = ""
    interpolation_details: str = ""
    line_calculation_details: str = ""
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "interpolation_details": self.interpolation_details,
            "line_calculation_details": self.line_calculation_details
        }
...
class MatchDetail:
    ...
    lines_with_appended_text: int = 0
    ...
    # New reconstruction fields
    reconstruction_font_family: str = ""
    reconstruction_font_size: str = ""
    reconstruction_line_count: int = 0
    reconstruction_reasoning: str = ""
    reconstruction_bbox_dimensions: str = ""
    ...
    def to_dict(self) -> Dict[str, Any]:
        result = {
            ...
            "lines_with_appended_text": self.lines_with_appended_text,
